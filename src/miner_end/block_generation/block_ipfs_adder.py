...
print("block ipfs adder code directory after folder structure: ", os.getcwd())
...
def block_ipfs_adder():
    ...
    raw_block_dir_lst.sort()
    print(raw_block_dir_lst)
    last_raw_block_name = os.path.join(raw_block_dir, raw_block_dir_lst[-1])
